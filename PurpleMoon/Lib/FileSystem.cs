    ...
    public static class FileSystem
    {
        ...
        public static bool DeleteFolder(string path)
        {
            if (FolderExists(path))
            {
                ...
                catch (Exception ex) { Debug.Panic(ex.Message); return false; }
            }
            else { return false; }
        }
        ...
        public static Cosmos.System.FileSystem.Listing.DirectoryEntry GetFileInfo(string file)
        {
            if (FileExists(file))
            {
                ...
                catch (Exception ex) { Debug.Panic(ex.Message); return null; }
            }
            else
            {
                Debug.Panic("Failed to get file info for %s", file);
                return null;
            }
        }
